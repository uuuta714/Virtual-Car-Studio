...
})({"fJQNg":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fc9894e146959012";
"use strict";
...
document.getElementById("setStartPositionFromMainCamera").addEventListener("click", function() {
    const cameraDetails = (0, _scriptsJs.getCameraDetails)((0, _scriptsJs.camera));
...
document.getElementById("setStartPositionFromCustomCamera").addEventListener("click", function() {
    const cameraDetails = (0, _scriptsJs.getCameraDetails)((0, _scriptsJs.customCamera));
    console.log("Camera Position:", cameraDetails.position);
    console.log("LookAt Position:", cameraDetails.lookAtPosition);
    // Set the values of the input fields for camera position
    document.getElementById("cameraStartPositionX").value = cameraDetails.position.x.toFixed(2);
...
document.getElementById("start-preview").addEventListener("click", function(event) {
    event.preventDefault();
    bsOffcanvas.hide();
    (0, _scriptsJs.cleanView)();
    (0, _scriptsJs.startCameraSequence)();
});
...
function updateCameraSequenceDropdown() {
    ...
    (0, _scriptsJs.cameraSequenceOptions).forEach((option)=>{
...
document.getElementById("addToSequenceButton").addEventListener("click", ()=>{
    ...
    if (selectedId) {
        (0, _scriptsJs.addCameraSequenceById)(selectedId);
        updateSequenceListDisplay();
        console.log("Updated Selected Camera Sequences:", (0, _scriptsJs.selectedCameraSequence));
    } else alert("Please select a camera sequence option first.");
});
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fJQNg","jd1tg"], "jd1tg", "parcelRequire6fcf")

//# sourceMappingURL=index.46959012.js.map
